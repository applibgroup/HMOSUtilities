...
public class DimensionHelper {
	...
	public static float dpToPx(final Context context, final float dpValue) {
		...
		final DeviceCapability metrics = context.getResourceManager().getDeviceCapability();
		return (int) TypedAttribute.computeTranslateRatio( metrics);
	}
	...
	public static float inToPx(final Context context, final float inValue) {
		...
		final DeviceCapability metrics = context.getResourceManager().getDeviceCapability();
		return  TypedAttribute.computeTranslateRatio(metrics);
	}
